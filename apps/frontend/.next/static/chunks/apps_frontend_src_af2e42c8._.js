            ...
            try {
                ...
                const syncToYjs = (state)=>{
                    ...
                    syncTimeout = setTimeout(()=>{
                        ...
                        if (JSON.stringify(prev.spaces) === JSON.stringify(state.spaces) && JSON.stringify(prev.players) === JSON.stringify(state.players) && prev.currentPlayerIndex === state.currentPlayerIndex && prev.season === state.season && prev.turn === state.turn && prev.gamePhase === state.gamePhase) {
                            return;
                        }
                        isUpdatingFromYjs = true;
...
//# sourceMappingURL=apps_frontend_src_af2e42c8._.js.map